...
<template>
  <TooltipPortal>
    ...
    >
      ...
      <TooltipArrow
        class="bg-popover fill-popover border-border z-150 size-2.5 translate-y-[calc(-50%-2px)] rotate-45 rounded-xs"
      />
    </TooltipContent>
  </TooltipPortal>
</template>
